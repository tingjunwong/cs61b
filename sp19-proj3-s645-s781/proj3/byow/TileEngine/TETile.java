...
public class TETile implements Serializable {
     ...
     *                        tile, shown in the GUI on hovering over the tile.
     * @param filepath        Full path to image
     *                        to be used for this tile. Must be correct size (16x16)
     */
    ...
    public boolean equals(Object o) {
        ...
        TETile t = (TETile) o;
        return this.backgroundColor.equals(t.backgroundColor) && this.character == t.character
                && this.description.equals(t.description) && this.textColor.equals(t.textColor);
    }

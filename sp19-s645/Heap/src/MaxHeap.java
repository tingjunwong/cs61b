public class MaxHeap<E extends Comparable<E>> {//存储任意的类型
    //   所以这些节点必须具有可比较性
...
//如果有右孩子且右孩子比左孩子大 此时j 为右孩子
                j = rightChild(k);
            }
//data[j] 是data[leftChild(k)]和data[rightChild(k)]两个节点值的最大值
...
//   看对于新的爸爸k来说  是否仍然需要继续下沉
    ...
    public MaxHeap(E[] arr) {
        ...
        data = new Array<>(arr);//根据用户传来的信息放进动态数组
//进行heapify的逻辑
